...
| 🐳 [`anpd-docker-infra`](https://github.com/anpdgovbr/anpd-docker-infra)                   | Infraestrutura Docker para PostgreSQL e pgAdmin                    | ![Status](https://img.shields.io/badge/Status-Planejamento-orange)         |
...
> 📝 **Nota:** Para questões de proteção de dados pessoais, consulte os [canais oficiais de atendimento](https://www.gov.br/anpd/pt-br/acesso-a-informacao/canais-de-atendimento) da ANPD.
